...
import gui.Ventana;
import gui.obra.PanelCrearObraCuadroGestor;
import sistema.Sistema;

public class ControladorPanelCrearObraCuadroGestor implements ActionListener {
	private Ventana ventana;
	private PanelCrearObraCuadroGestor panel;
	
	public ControladorPanelCrearObraCuadroGestor (Ventana v) {
		this.ventana = v;
		this.panel = v.getPanelCrearObraCuadroGestor();
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		String tecnica = this.panel.getTecncaField().getText();
		...
		if (e.getActionCommand().equals("aceptar")) {
			if (titulo.equals("") && autor.equals("") && anyo.equals("") && descripcion.equals("") && cuantia.equals("") && nunPoliza.equals("") && tMin.equals("") && tMax.equals("")
					&& ancho.equals("") && largo.equals("") && alto.equals("") && tecnica.equals("")) {
				...
				try {
					...
					sis.darAltaCuadro(titulo, autor, centro, dAnyo, descripcion, dCuantia, nunPoliza, dTMin, dTMax, dHMin, dHMax, dAncho, dLargo, dAlto, tecnica);
				}
